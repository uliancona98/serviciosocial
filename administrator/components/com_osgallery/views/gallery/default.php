                        ...
                        <div class="category-options-content tab-content">
                            <div id="img-options-block" class="tab-pane fade">
                                ...
                                <div class="img-publish">
                                    ...
                                    <span class="cat-col-2">
                                        <div id="img_publish" class="osgallery-checkboxes-block">
                                            ...
                                            <label for="img_publish-yes" data-value="Yes">Yes</label>
                                            <label for="img_publish-no" data-value="No">No</label>
                                        </div>
                                    </span>
                                </div>
                                ...
                                <div class="type_html_code osg-pro-avaible-string">
                                    ...
                                    <span class="cat-col-2">
                                        <textarea id="img-html" name="imgHtml" type="text" value="" rows="3" cols="10" disabled=""></textarea>
                                    </span>
                                </div>
                                ...
                                <div class="html-position">
                                    ...
                                    <span class="cat-col-2">
                                        <select id="html-position-img" name="htmlPosition">
                                            ...
                                            <option value="bottom" disabled=""><?php echo JText::_("Bottom")?></option>
                                        </select>
                                    </span>
                                </div>
                                <span class="clearfix" ></span>
                                ...
                                <div class="cat-show-title">
                                    ...
                                    <span class="cat-col-2">
                                        <div class="osgallery-checkboxes-block">
                                            ...
                                            <label for="cat-show-title-yes" data-value="Yes">Yes</label>
                                            <label for="cat-show-title-no" data-value="No">No</label>
                                    ...
                                    <div>
                                        ...
                                        <span class="cat-col-2">
                                            <select id="cat-title-position" name="catTitlePosition">
                                                ...
                                                <option  value="onImage">On the image</option>
                                                <option  value="top">Top above image</option>
                                                <option  value="bottom">Bottom under image</option>
                                            </select>
                                        </span>
                                    </div>
...
<!--                                          <input type="checkbox" value="None" id="cat-unpublish" name="check" checked="checked"/>
                                        ...
                                        <div class="osgallery-checkboxes-block">
                                            ...
                                            <label for="cat-publish-yes" data-value="Yes">Yes</label>
                                            <label for="cat-publish-no" data-value="No">No</label>
                                        </div>
                                    </span>
                                </div>
                            </div>
            ...
            <div id="os-tab-settings" class="tab-content">
                ...
                <div id="general-settings" class="tab-pane fade">
                        ...
                        <div>
                            ...
                            <span class="cat-col-2">
                                <select class="gallery-layout" name="galleryLayout">
                                    <option selected="selected" value="defaultTabs">Default</option>
                                    <option class="disabled" disabled value="allInOne">All in one</option>
                                    <option class="disabled" disabled value="albumMode">Album</option>
                                    <option class="disabled" disabled value="masonry">Masonry</option>
                                    <option class="disabled" disabled value="fit_rows">fitRows</option>
                                </select>
                            </span>
                        </div>
                        ...
                        <div>
                            ...
                            <span class="cat-col-2">
                                <select name="imageHover">
                                    ...
                                    <option class="disabled" disabled="" value="anet">Anet</option>
                                    <option class="disabled" disabled="" value="sergio">Sergio</option>
                                    <option class="disabled" disabled="" value="ariana">Ariana</option>
                                    ...
                                    <option class="disabled" disabled="" value="pytiton">Pytiton</option>
                                    <option class="disabled" disabled="" value="oleg">Oleg</option>
                                </select>
                            </span>
                        </div>
                    ...
                    <div id="order">
                        ...
                        <span class="cat-col-2">
                            <select name="order">
                                <option <?php echo ($order == "drag_and_drop")?'selected="selected"':''?> value="drag_and_drop">Drag and drop</option>
                                <option class="disabled" disabled="" value="file_name">File name</option>
                                <option class="disabled" disabled="" value="title">Title</option>
                                <option class="disabled" disabled="" value="upload_date">Upload time</option>
                            </select>
                        </span>
                    </div>
                    ...
                    <div id="imgTextPosition" <?php echo ($gallerylayout == "allInOne")?'style="display:none;"':'';?>>
                        ...
                        <span class="cat-col-2">
                            <select name="imgTextPosition">
                                <option <?php echo ($imgTextPosition == "none")?'selected="selected"':''?> value="none">Do not display</option>
                                <option <?php echo ($imgTextPosition == "onImage")?'selected="selected"':''?> value="onImage">On the image</option>
                                <option <?php echo ($imgTextPosition == "top")?'selected="selected"':''?> value="top">Top above image</option>
                                <option <?php echo ($imgTextPosition == "bottom")?'selected="selected"':''?> value="bottom">Bottom under image</option>
                            </select>
                        </span>
                    </div>
                        ...
                        <div>
                            ...
                            <span class="cat-col-2">
                                <select name="showLoadMore" <?php if($gallerylayout == "allInOne") echo 'disabled="disabled"';?>>
                                    ...
                                    <option class="disabled" disabled="" value="button">Load More by Button</option>
                                    <option class="disabled" disabled="" value="scroll">Load more by Scroll</option>
                                    <option class="disabled" disabled="" value="auto">Auto Load all pictures</option>
                    ...
                    <div>
                        ...
                        <span class="sett-col-2">
                            <select name="fancy_box_background">
                                <option <?php echo $fancy_box_background=="gray"?'selected':''?> value="rgba(0, 0, 0, 0.75)"><?php echo JText::_("COM_OSGALLERY_SETTINGS_OS_FANCYBOX_BACKGROUND_COLOR_SELECT_OPTION1")?></option>
                                <option <?php echo $fancy_box_background=="white"?'selected':''?> value="rgba(238,238,238,0.85)"><?php echo JText::_("COM_OSGALLERY_SETTINGS_OS_FANCYBOX_BACKGROUND_COLOR_SELECT_OPTION2")?></option>
                                <option <?php echo $fancy_box_background=="transparent"?'selected':''?> value="rgba(0,0,0,0)"><?php echo JText::_("COM_OSGALLERY_SETTINGS_OS_FANCYBOX_BACKGROUND_COLOR_SELECT_OPTION3")?></option>
                            </select>
                        </span>
                    </div>
...
<script language="JavaScript">
    ...
    function showHideSetting(){
        var externalGallery = jQuery('#externalGallerySettings').val();
        
        if(externalGallery == 0){
            jQuery('.main-setting').slideDown(400);
            jQuery('#os_fancybox-settings, #watermark-settings, #social-settings').css('display', '');
        }else{
            jQuery('.main-setting, #os_fancybox-settings, #watermark-settings, #social-settings').slideUp(400);
        }
    ...
    function showHideCategoryTitleHeight(){
        ...
        var titlePosition = jQuery('#cat-title-position').val()
        if(titlePosition == 'top' || titlePosition == 'bottom'){
            jQuery(".cat-title-height").slideDown(400);
        }else{
            jQuery(".cat-title-height").slideUp(400);
        }
        
    }
    
    jQuery('#externalGallerySettings').on('change', function(){
        showHideSetting();
    })
    
    jQuery('#cat-title-position').on('change', function(){
        showHideCategoryTitleHeight();
    })
  ...
  //end
    ...
    Joomla.submitbutton = function(pressbutton) {
        if(pressbutton =='open_gallery_settings'){
            ...
            if(pressbutton=='save_gallery' || pressbutton=='save_close_galery'){
                ...
                //grab all form data
                var inputArray = jQuery("#adminForm").serialize();
                    ...
                    success: function (data) {
                        ...
                        if (data.success) {
                            ...
                            if(pressbutton=='save_close_galery'){
                                jQuery("button.button-cancel").trigger('click');
                            }
                        }else{
                          console.log('oops');
                        }
    ...
    jQuery(".add-new-cat").click(function(event) {
        ...
        jQuery("#cat-desc").val(catSettings.categoryDescription || '');
        jQuery("#cat-title-position").val(catSettings.catTitlePosition || '');
        jQuery("#cat-title-height-block").val(catSettings.catTitleHeight || 0);
        showHideCategoryTitleHeight();
        //jQuery("#cat-unpublish").prop("checked",!catSettings.categoryUnpublish);
        if (catSettings.categoryUnpublish != undefined) {
            if (catSettings.categoryUnpublish == false) jQuery('#cat-publish-yes').attr("checked",true);
            if (catSettings.categoryUnpublish == true) jQuery('#cat-publish-no').attr("checked",true);
        } else {
            jQuery('#cat-publish-yes').attr("checked",true);
        }
        //jQuery("#cat-show-title").prop("checked",catSettings.categoryShowTitle);
        if (catSettings.categoryShowTitle != undefined) {
            if (catSettings.categoryShowTitle == true) jQuery('#cat-show-title-yes').attr("checked",true);
            if (catSettings.categoryShowTitle == false) jQuery('#cat-show-title-no').attr("checked",true);
        } else {
            jQuery('#cat-show-title-yes').attr("checked",true);
        }
        ...
        if (imgSettings.img_publish) {
            if (imgSettings.img_publish == "yes") jQuery("#img_publish").find('#img_publish-yes').attr("checked",true);
            if (imgSettings.img_publish == "no") jQuery("#img_publish").find('#img_publish-no').attr("checked",true);
        } else {
            jQuery("#img_publish").find('#img_publish-yes').attr("checked",true);
        }
...
//end
    ...
    function catSettingsFunctions(){
        ...
        jQuery("#cat-alias").val(catSettings.categoryAlias || '');
        jQuery("#cat-desc").val(catSettings.categoryDescription || '');
        jQuery("#cat-title-position").val(catSettings.catTitlePosition || 'onImage');
        jQuery("#cat-title-height-block").val(catSettings.catTitleHeight || '');
        showHideCategoryTitleHeight();
        //jQuery("#cat-unpublish").prop("checked",!catSettings.categoryUnpublish);
        ...
        jQuery(".cat-nav-tabs a").click(function(e){
            ...
            if(Object.keys(catSettings).length == 0 ) {
                ...
                jQuery("#cat-desc").val('');
                jQuery("#cat-title-position").val('onImage');
                jQuery("#cat-title-height-block").val(0);
        ...
        jQuery("#cat-layout, #cat-unpublish, #cat-show-title, #cat-show-cat-title-caption,#cat-alias,#cat-desc, #cat-title-position, #cat-title-height-block").on('customCat', function (e) {
            //get params from jsonString
            catSettings = parceOptions(jQuery("#cat-settings-"+activeId).val());
            catSettings.categoryAlias = checkSpecialChar(jQuery("#cat-alias").val());
            catSettings.categoryDescription = checkSpecialChar(jQuery("#cat-desc").val());
            catSettings.catTitlePosition = jQuery("#cat-title-position").val();
            catSettings.catTitleHeight = jQuery("#cat-title-height-block").val();
        ...
        jQuery("#cat-layout, #cat-unpublish, #cat-show-title, #cat-show-cat-title-caption, #cat-title-position, #cat-title-height-block").change(function(event) {
            jQuery(this).trigger( "customCat");
        });
        jQuery("#cat-alias, #cat-desc").on('input', function (e) {
            jQuery(this).trigger( "customCat");
        });
        //end
    }
    ...
    function addCheckedToPublishImgCheckbox () {
        jQuery(".img-publish input").click(function(e) {
            var id = jQuery(this).attr('id');
            var imageId = jQuery('.active-img-block').data("image-id");
            var imgSettings = parceOptions(jQuery("#img-settings-"+imageId).val());
            ...
            if (id == 'img_publish-yes') {
                jQuery(this).attr('checked', 'checked');
                jQuery(".img-publish").find('#img_publish-no').attr("checked",false);
                imgSettings.img_publish = "yes";
                jQuery("#img-settings-"+imageId).val(encodeURI(window.JSON.stringify(imgSettings)));

            } else {
                jQuery(this).attr('checked', 'checked');
                jQuery(".img-publish").find('#img_publish-yes').attr("checked",false);
    ...
    function addCheckedToShowCategoryTabsCheckbox () {
        jQuery(".cat-show-title input").click(function(e) {
            ...
            if (id == 'cat-show-title-yes') {
                jQuery(this).attr('checked', 'checked');
                jQuery(".cat-show-title").find('#cat-show-title-no').attr("checked",false);
                catSettings.categoryShowTitle = true;
                jQuery("#cat-settings-"+activeId).val(encodeURI(window.JSON.stringify(catSettings)));

            } else {
                jQuery(this).attr('checked', 'checked');
                jQuery(".cat-show-title").find('#cat-show-title-yes').attr("checked",false);
    ...
    function addCheckedToCategoryPublishCheckbox () {
        jQuery(".cat-publish input").click(function(e) {
            ...
            if (id == 'cat-publish-yes') {
                jQuery(this).attr('checked', 'checked');
                jQuery(".cat-publish").find('#cat-publish-no').attr("checked",false);
                catSettings.categoryUnpublish = false;
                jQuery("#cat-settings-"+activeId).val(encodeURI(window.JSON.stringify(catSettings)));

            } else {
                jQuery(this).attr('checked', 'checked');
                jQuery(".cat-publish").find('#cat-publish-yes').attr("checked",false);
    ...
    function tabsChangeDependences(){
        ...
        jQuery(".gallery-layout[name='galleryLayout']").change(function(event) {
            ...
            var imgTextPosition = jQuery("#imgTextPosition [name='imgTextPosition']").val();
            //masonry
            ...
            if(galleryLayout == 'allInOne'){
                ...
                jQuery("#imgTextPosition").slideUp(400);
            }else{
                ...
                jQuery("#imgTextPosition").slideDown(400);
            }

            //allInOne & albumMode
            if(galleryLayout == "allInOne" || galleryLayout == "albumMode"){
                jQuery(".cat-position-title-block").slideDown(400);
            }else{
                jQuery(".cat-position-title-block").slideUp(400);
            }
            
            //allInOne & masonry
            if(galleryLayout == "allInOne" || galleryLayout == "masonry"){
                jQuery("#imgTextHeight").slideUp(400);
            }else{
                if(imgTextPosition != 'onImage' && imgTextPosition != 'none' ){
                    jQuery("#imgTextHeight").slideDown(400);
                }
            }

        });
        //change galleryLayout
        jQuery("#imgTextPosition [name='imgTextPosition']").change(function(event) {
            var imgTextPosition = jQuery(this).val();
            var galleryLayout = jQuery(".gallery-layout[name='galleryLayout']").val();
            if(imgTextPosition == 'onImage' || imgTextPosition == 'none' ){
                jQuery("#imgTextHeight").slideUp(400);
            }else{
                if(galleryLayout != 'masonry'){
        ...
        jQuery("select[name='order']").change(function(event) {
            var order = jQuery(this).val();
            if(order == 'drag_and_drop'){
                jQuery("#orderBy").slideUp(400);
            }else{
                jQuery("#orderBy").slideDown(400);
            }
        })
        //change loadMoreType
