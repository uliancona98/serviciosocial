...
return [
    ...
    'timestamp' => 1586446478,
    'checksum' => 'e9e41df5931472f2b7a69abe4f0095af',
    'files' => [
        'templates/g5_prometheus/custom/config/16' => [
            'assignments' => [
                'file' => 'templates/g5_prometheus/custom/config/16/assignments.yaml',
                'modified' => 1586446476
            ],
            'index' => [
                'file' => 'templates/g5_prometheus/custom/config/16/index.yaml',
                'modified' => 1586446455
            ],
            'layout' => [
                'file' => 'templates/g5_prometheus/custom/config/16/layout.yaml',
                'modified' => 1586446455
            ],
            'page/assets' => [
                'file' => 'templates/g5_prometheus/custom/config/16/page/assets.yaml',
                'modified' => 1586446455
            ],
            'page/body' => [
                'file' => 'templates/g5_prometheus/custom/config/16/page/body.yaml',
                'modified' => 1586446455
            ],
            'page/head' => [
                'file' => 'templates/g5_prometheus/custom/config/16/page/head.yaml',
                'modified' => 1586446455
            ],
            'styles' => [
                'file' => 'templates/g5_prometheus/custom/config/16/styles.yaml',
                'modified' => 1586446455
            ]
        ],
