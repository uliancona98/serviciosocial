...
return [
    ...
    'timestamp' => 1586446301,
    'checksum' => '997903c4576c4bd31f6cf3d077c577a0',
    'files' => [
        'templates/g5_prometheus/custom/config/15' => [
            'assignments' => [
                'file' => 'templates/g5_prometheus/custom/config/15/assignments.yaml',
                'modified' => 1586446294
            ],
            'index' => [
                'file' => 'templates/g5_prometheus/custom/config/15/index.yaml',
                'modified' => 1586446190
            ],
            'layout' => [
                'file' => 'templates/g5_prometheus/custom/config/15/layout.yaml',
                'modified' => 1586446190
            ],
            'page/assets' => [
                'file' => 'templates/g5_prometheus/custom/config/15/page/assets.yaml',
                'modified' => 1586446190
            ],
            'page/body' => [
                'file' => 'templates/g5_prometheus/custom/config/15/page/body.yaml',
                'modified' => 1586446190
            ],
            'page/head' => [
                'file' => 'templates/g5_prometheus/custom/config/15/page/head.yaml',
                'modified' => 1586446190
            ],
            'styles' => [
                'file' => 'templates/g5_prometheus/custom/config/15/styles.yaml',
                'modified' => 1586446190
            ]
        ],
            ...
            'contentcubes' => [
                ...
                'items' => [
                    0 => [
                        ...
                        'label' => 'Label',
                        'title' => 'HEADLINE',
                        'content' => 'Morbi non</strong> sodales nisi. Suspendisse feugiat quam Morbi non sodales nisi. Suspendisse feugiat quam',
                        'tags' => [
                            0 => [
                                'icon' => 'fa fa-tag',
                                'link' => '#',
...
<li>Visual Layout Manager</li>
<li>Unlimited Undo/Redo</li>
<li>SCSS / LESS Support</li>
<li>Off-Canvas Panel</li>
<li>Particles System</li>
<li>Twig-based Templating</li>
...
<li>YAML-based Configuration</li>
            ...
            'copyright' => [
                ...
                'additional' => [
                    'text' => 'Powered by <a href = "http://gantry.org/">Gantry5</a> framework'
                ],
                'css' => [
                    'class' => ''
                ]
            ...
            'branding' => [
                ...
                'enabled' => '1',
                'content' => 'Powered by <a href="http://szoupi.com" title="szoupi" class="g-powered-by">SZOUPI</a>',
                'css' => [
                    'class' => 'g-branding'
                ]
            ],
            ...
            'logo' => [
                ...
                'svg' => '',
                'text' => 'PROMETHEUS',
                'class' => 'g-logo g-logo-prometheus'
            ],
            'menu' => [
                'caching' => [
                    'type' => 'menu'
            ...
            'pricetableSZ' => [
                ...
                'pricetables' => [
                    0 => [
                        'image' => '',
                        'icon' => 'fa fa-diamond fa-3x',
                        'price' => '0.01$',
                        'description' => 'Morbi non sodales nisi.
Suspendisse feugiat quam
Morbi non sodales nisi.
Suspendisse feugiat quam',
                        'line1' => 'Morbi non sodales nisi.',
                        'line2' => 'Suspendisse feugiat quam',
                        'line3' => 'Morbi non sodales nisi.',
                        'line4' => 'Morbi non sodales nisi.',
                        'link' => '#',
                        'linktext' => 'Enroll Now!',
                        'class' => '',
                        'title' => 'table1'
...
Morbi non sodales nisi.
Suspendisse feugiat quam',
                        'line1' => 'Suspendisse feugiat quam',
                        'line2' => 'Morbi non sodales nisi.',
                        'line3' => 'Suspendisse feugiat quam',
                        'line4' => 'Morbi non sodales nisi.',
                        'link' => '#',
                        'linktext' => 'Enroll Now!',
                        'class' => 'box1',
...
Suspendisse feugiat quam',
                        ...
                        'line2' => 'Suspendisse feugiat quam',
                        'line3' => 'Morbi non sodales nisi.',
                        'line4' => 'Suspendisse feugiat quam',
                        'link' => '#',
                        'linktext' => 'Enroll Now!',
                        'class' => '',
                        'title' => 'table3'
            ...
            'testimonialSZ' => [
                ...
                'testimonials' => [
                    0 => [
                        'icon' => 'fa fa-quote-left fa-3x',
                        'quote' => 'You\'ll come to learn a great deal if you study the Insignificant in depth.',
                        'author' => 'Odysseus Elytis',
                        'authorattribute' => 'Poet',
                        'image' => 'gantry-media://demos/oliver_hardy.jpg',
                        'effect' => 'arrow',
                        'class' => '',
                        'title' => 'quote1'
                    ],
                    1 => [
                        ...
                        'author' => 'Ainstein',
                        'authorattribute' => 'Scientist',
                        'image' => 'gantry-media://demos/einstein.jpg',
                        'effect' => 'arrow',
                        'class' => '',
                        'title' => 'quote2'
                    ],
                    2 => [
                        ...
                        'author' => 'Socrates',
                        'authorattribute' => 'Greek Philosopher',
                        'image' => 'gantry-media://demos/chaplin.jpeg',
                        'effect' => 'arrow',
                        'class' => '',
                        'title' => 'quote3'
                    ]
        ...
        'styles' => [
            ...
            'sectionsdim' => [
                ...
                'intro-margin' => '0rem',
                'intro-padding' => '0rem',
                'features-margin' => '0rem',
                'features-padding' => '0rem',
                'utility-margin' => '0rem',
                'utility-padding' => '0rem',
                'above-margin' => '0rem',
                'above-padding' => '0rem',
                'testimonials-margin' => '0rem',
                'testimonials-padding' => '0rem',
                'expanded-margin' => '0rem',
                'expanded-padding' => '0rem',
                'mainbottom-margin' => '0rem',
                'mainbottom-padding' => '0rem',
                'footertop-margin' => '0rem',
                'footertop-padding' => '0rem',
                'footer-margin' => '0rem',
                'footer-padding' => '0rem',
                'footerbottom-margin' => '0rem',
                'footerbottom-padding' => '0rem',
                'nadir-margin' => '0rem',
                'nadir-padding' => '0rem'
            ],
            'testimonials' => [
        ...
        'page' => [
            'body' => [
                'attribs' => [
                    'class' => 'gantry g-prometheus-style',
                    'id' => '',
                    'extra' => [
