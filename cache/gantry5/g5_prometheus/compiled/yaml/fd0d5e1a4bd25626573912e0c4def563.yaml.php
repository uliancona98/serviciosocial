...
return [
    ...
    'filename' => 'C:/MAMP/htdocs/serviciosocial/templates/g5_prometheus/blueprints/styles/footertop.yaml',
    'modified' => 1583792621,
    'data' => [
        'name' => 'Footertop Styles',
        'description' => 'Footertop section styles for the Prometheus theme',
        'type' => 'section',
        'form' => [
            'fields' => [
                'section-preset' => [
