...
return [
    ...
    'filename' => 'C:/MAMP/htdocs/servicioSocial/templates/g5_prometheus/blueprints/styles/mainbottom.yaml',
    'modified' => 1582763250,
    'data' => [
        'name' => 'Mainbottom Styles',
        'description' => 'Mainbottom section content styles for the Prometheus theme',
        'type' => 'section',
        'form' => [
            'fields' => [
                'section-preset' => [
